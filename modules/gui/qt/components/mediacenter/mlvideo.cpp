    ...
    })
{
    ...
    for( const vlc_ml_media_track_t& track: ml_range_iterate<vlc_ml_media_track_t>( data->p_tracks) ) {
        if (track.i_type == VLC_ML_TRACK_TYPE_AUDIO) {
            ...
            audioDesc = "Codec: "+QString::fromUtf8(track.psz_codec) + " Language: "+QString::fromUtf8(track.psz_language) + " Channels: "+QString::number(track.a.i_nbChannels) + " Sample Rate: " + QString::number(track.a.i_sampleRate) + "\n";
        }
            ...
            videoDesc = "Codec: "+QString::fromUtf8(track.psz_codec) + " Language: "+QString::fromUtf8(track.psz_language) + " FPS: "+QString::number(track.v.i_fpsNum) + "\n";
        }
    }
